    ...
    return (
      ...
      <div className={generalStyles.main}>
          ...
          <div>
            ...
            :<><label htmlFor="lastName">Last Name: </label><input onChange={this.handleChange} value={lastName} type="text" id="lastName" placeholder="Doe" required/></>}
          </div> 
          <div>
          ...
          <div>
            ...
            :<><label htmlFor="phone">Phone: </label><input onChange={this.handleChange} value={phone} type="tel" pattern="[0-9]{3}-[0-9]{3}-[0-9]{4}"id="phone" placeholder="Phone" required/></>}
          </div> 
          {generalInfoSaved?<button  className={generalStyles.button} onClick={this.onEditInfo}>Edit</button>:<button className={generalStyles.button} onClick={this.onSaveInfo}>Save</button>}
        </div>
      </div>
      </>
    )
